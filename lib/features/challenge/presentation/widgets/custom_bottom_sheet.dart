...
/// sheet be draggable.
typedef CustomScrollableWidgetBuilder = Widget Function(
...
class CustomDraggableScrollableController extends ChangeNotifier {
  ...
  CustomDraggableScrollableController() {
...
/// [CustomScrollableWidgetBuilder] does not use the provided [ScrollController], the
...
/// manipulating the sheet size via [CustomDraggableScrollableController.animateTo] or
/// [CustomDraggableScrollableController.jumpTo] will ignore [snap] and [snapSizes].
///
...
class CustomDraggableScrollableSheet extends StatefulWidget {
  ...
  /// was first built or since the last call to [CustomDraggableScrollableActuator.reset].
  ///
  ...
  /// calling [CustomDraggableScrollableController.animateTo] or [CustomDraggableScrollableController.jumpTo].
  ///
  ...
  /// [CustomDraggableScrollableActuator.reset].
  final bool snap;
  ...
  /// being built or since the last call to [CustomDraggableScrollableActuator.reset].
  ...
  ///
  /// Set on emitted [CustomDraggableScrollableNotification]s. It is up to parent
  ...
  /// of the contents.
  final CustomScrollableWidgetBuilder builder;
      ...
      WidgetsBinding.instance.addPostFrameCallback((Duration timeStamp) {
        for (int index = 0; index < _scrollController.positions.length; index++) {
          final _CustomDraggableScrollableSheetScrollPosition position =
            _scrollController.positions.elementAt(index) as _CustomDraggableScrollableSheetScrollPosition;
...
/// A [ScrollController] suitable for use in a [CustomScrollableWidgetBuilder] created
...
class CustomDraggableScrollableActuator extends StatefulWidget {
  ...
  ///
  /// Returns `true` if a [CustomDraggableScrollableActuator] is available and
  ...
  @override
  State<CustomDraggableScrollableActuator> createState() => _CustomDraggableScrollableActuatorState();
}

class _CustomDraggableScrollableActuatorState extends State<CustomDraggableScrollableActuator> {
...
Future<T?> showCustomDraggableBottomSheet<T>({
  ...
  CustomDraggableScrollableController? controller,
}) {
